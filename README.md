...
**ORCUS**, akıllı alan taraması ve hedef kilitlenmesi için tasarlanmış gelişmiş bir otonom sürü kamikaze dron sistemidir. Roma ölüm tanrısı Orcus'tan ismini alan bu sistem, birden fazla drone'u koordine ederek belirlenmiş alanları bağımsız olarak tarar, yapay zeka destekli bilgisayarlı görü ile insan hedeflerini tespit eder ve hassas çarpma görevi gerçekleştirir.
